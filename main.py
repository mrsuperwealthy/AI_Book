...
st.write("""
# Ai Book : Generate a book in seconds😀
""")
...
try:
    ...
    with st.form("groqform"):
        if not GROQ_API_KEY:
            groq_input_key = st.text_input("Enter your API Key (Groq.):", "",type="password")

        topic_text = st.text_input("What do you want the book to be about? (literally write anything🙂)", "")
